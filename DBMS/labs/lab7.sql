...
SELECT COUNT(enrollment_num), full_name FROM student GROUP BY full_name;
SELECT COUNT(enrollment_num), full_name FROM student GROUP BY full_name ORDER BY COUNT(branch) DESC;
SELECT * FROM student where gender="F" Having age=18 Union SELECT * FROM student where gender="M" Having age=18;
-- SELECT * FROM student where gender="F" Having age=18;
